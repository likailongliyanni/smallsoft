...
class DesktopAssistantController extends Controller
{
    public function chat(Request $request, TokenService $tokens, DocumentAssistantService $assistant): array
    {
        ...
        $data = $request->validate([
            ...
            'contract_context' => ['nullable', 'array'],
            'contract_context.template_id' => ['nullable', 'integer', 'min:1'],
            'contract_context.source_document_id' => ['nullable', 'integer', 'min:0'],
            'contract_context.supplier_name' => ['nullable', 'string', 'max:200'],
            'contract_context.payee_name' => ['nullable', 'string', 'max:200'],
            'contract_context.bank_name' => ['nullable', 'string', 'max:200'],
            'contract_context.bank_account' => ['nullable', 'string', 'max:100'],
            'contract_context.supporting_ids' => ['nullable', 'array', 'max:20'],
            'contract_context.supporting_ids.*' => ['integer', 'min:1'],
            'contract_context.line_items' => ['nullable', 'array', 'max:30'],
            'contract_context.line_items.*' => ['array'],
            'contract_context.delivery_address' => ['nullable', 'string', 'max:300'],
            'contract_context.delivery_deadline' => ['nullable', 'string', 'max:300'],
            'contract_context.payment_terms' => ['nullable', 'string', 'max:500'],
            'contract_context.output_name' => ['nullable', 'string', 'max:100'],
            'knowledge_hits' => ['nullable', 'array', 'max:12'],
            'knowledge_hits.*.document_id' => ['required', 'integer', 'min:1'],
            'knowledge_hits.*.file_name' => ['required', 'string', 'max:255'],
            'knowledge_hits.*.type_label' => ['nullable', 'string', 'max:100'],
            'knowledge_hits.*.company' => ['nullable', 'string', 'max:200'],
            'knowledge_hits.*.page_number' => ['nullable', 'integer', 'min:0'],
