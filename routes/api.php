...
use App\Http\Controllers\DesktopAssistantController;
...
use App\Http\Controllers\SoftwareConfigController;
use App\Http\Controllers\SoftwareReleaseController;
use App\Http\Controllers\StatsAnalysisController;
...
Route::post('/desktop/assistant/chat', [DesktopAssistantController::class, 'chat']);
...
Route::post('/excel-automation/stats/plan', [StatsAnalysisController::class, 'plan']);
Route::post('/excel-automation/stats/insight', [StatsAnalysisController::class, 'insight']);
...
Route::get('/software/releases', [SoftwareReleaseController::class, 'index']);
...
Route::get('/admin/software-configs', [SoftwareConfigController::class, 'index']);
Route::post('/admin/software-configs', [SoftwareConfigController::class, 'store']);
Route::post('/admin/software-configs/{config}/test', [SoftwareConfigController::class, 'test'])->whereNumber('config');
Route::delete('/admin/software-configs/{config}', [SoftwareConfigController::class, 'destroy'])->whereNumber('config');
Route::get('/admin/software-releases', [SoftwareReleaseController::class, 'adminList']);
Route::post('/admin/software-releases', [SoftwareReleaseController::class, 'adminStore']);
Route::post('/admin/software-releases/{release}/activate', [SoftwareReleaseController::class, 'adminActivate'])->whereNumber('release');
Route::post('/admin/software-releases/{release}/disable', [SoftwareReleaseController::class, 'adminDisable'])->whereNumber('release');
Route::delete('/admin/software-releases/{release}', [SoftwareReleaseController::class, 'adminDestroy'])->whereNumber('release');
